				...
				<div class="row pb-50 pb-xs-30">
					<div class="col-lg-4">
						...
						<div class="col-lg-8 d-flex justify-content-end">
							...
							<li>
								<a class="categories active" data-filter="*">All Images</a>
							</li>
							<li>
								<a class="categories" data-filter=".recent"> Recent</a>
							</li>
							<li>
								<a class="categories" data-filter=".safari">Safari</a>
							</li>
							<li>
								<a class="categories" data-filter=".events">Events</a>
							</li>
